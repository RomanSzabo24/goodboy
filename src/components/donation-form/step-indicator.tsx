        ...
        return (
          ...
          >
            <span
              ...
              className={cn(
                "flex size-8 shrink-0 items-center justify-center rounded-full border text-base transition-colors duration-500",
            ...
            >
              {isComplete ? (
                <Check className="size-4 animate-in zoom-in-50 duration-500" aria-hidden="true" />
              ) : (
                index + 1
              )}
            </span>
            <span
              className={cn(
                "hidden shrink-0 text-base whitespace-nowrap text-muted-foreground/30 transition-colors duration-500 @xl:inline",
            ...
            {index < stepLabels.length - 1 && (
              <span
                aria-hidden="true"
                className={cn(
                  "h-px min-w-6 flex-1 bg-border transition-colors duration-500",
